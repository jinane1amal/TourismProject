...
legend("topright", legend = c("2019_arrivals"), col = c("red"), pch = 1)
...
```{r}
boxplot(Tab$'2019_arrivals' ~ Tab$'2019_avg', data = Tab, col = "lightblue", xlab = "2019_avg", ylab = "2019_arrivals", main = "Boxplot")
...
```{r}
boxplot(Tab$'2020_arrivals' ~ Tab$'2020_avg', data = Tab, col = "lightblue", xlab = "2020_avg", ylab = "2020_arrivals", main = "Boxplot")
